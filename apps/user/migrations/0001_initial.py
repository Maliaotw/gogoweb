# Generated by Django 3.1.7 on 2021-08-30 15:21
...
def createsuperuser(apps, schema_editor):
    ...
    if os.getenv("TRAMPOLINE_CI", None):
        ...
        admin_user = settings.DJANGO_SUPERUSER_USERNAME
    ...
    User.objects.create_superuser(admin_user, password=admin_password.strip())
